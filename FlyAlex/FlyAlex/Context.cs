...
namespace FlyAlex
{
    public class Context : DbContext
    {
        ...
        public static string ConnectionString { get; set; } = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\Alexandre The Goat\Documents\12345.mdf"";Integrated Security=True;Connect Timeout=30";
        public Context() { }
